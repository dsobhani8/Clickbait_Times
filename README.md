...
Run the app against a backend explicitly:
```bash
...
Keep local operational notes in `README.local.md`. That file is intentionally gitignored and is not part of the public repository documentation.
